...
Physics_Joint_2D::Physics_Joint_2D(b2Joint* _pJoint, float _pixelsPerMeter)
{
	m_pJoint = _pJoint;
	m_pixelsPerMeter = _pixelsPerMeter;
}

Physics_Joint_2D::~Physics_Joint_2D()
{
}

v2float Physics_Joint_2D::GetAnchorA()
{
...
v2float Physics_Joint_2D::GetAnchorB()
{
