...
public:
	...
	* @author: Callan Moore
	* @parameter: _tech: Denotes which litTex Technique to use in the Renderering. Default to Standard Tech
	* @parameter: _plane: Additional Plane for certain techniques. Defaults to all zeroes
	* @return: void
	********************/
	virtual void Render(eTech_LitTex _tech = TECH_LITTEX_STANDARD, D3DXPLANE _plane = { 0, 0, 0, 0 });
