...
public:
	...
	********************/
	...
	/***********************
	* GetWorldMatrix: Retrieve teh world matrix of the object
	* @author: Callan Moore
	* @return: D3DXMATRIX: The objects world matrix
	********************/
	D3DXMATRIX GetWorldMatrix() { return m_matWorld; };

	// TO DO CAL
	ID3D10ShaderResourceView* GetFirstTexture() { return (*m_pTextures)[0]; };
