...
public:
	...
	* @author: Callan Moore
	* @parameter: _plane: The plane of reflection
	* @return: void
	********************/
	...
	********************/
	...
	/***********************
	* GetActiveShadowMaps: Retrieve the current active shadow maps in the scene
	* @author: Callan Moore
	* @return: std::map<std::string, DX10_TextureResource*>**: The current active shadow maps
	********************/
	std::map<std::string, DX10_TextureResource*>* GetActiveShadowMaps();
...
private:
	...
	// Shadows
	std::map<std::string, DX10_TextureResource*> m_shadowMaps;
};
